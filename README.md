...
3. Set environment variables:
    ...
    3. set `PORT` and `YOUR_SECRET_API_KEY` values same as in .env.example file.
    4. to get Gemini API: search in browser "google ai studio", Login and create a new API key, copy it and paste in `GEMINI_API_KEY` value.
...
***Processing 5 minutes of audio with gemini-3-flash-preview costs about $0.0096 USD only, based on April 2026 prices.***
